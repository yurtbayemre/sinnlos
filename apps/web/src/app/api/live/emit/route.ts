 ...
 * the only session-less web endpoint since D-DC01 removed the cache-
 * revalidation webhook; REVALIDATE_SECRET / x-revalidate-secret keep their
 * names but guard this route alone.
 */
