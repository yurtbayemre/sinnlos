...
const announcements: AnyEntry[] = [
  {
    ...
    body: "Join us at 15:00 CET in the main auditorium or on Teams.",
    pinned: true,
  ...
  },
  {
    ...
    body: "Hit ⌘K anywhere in the app to fuzzy search wiki pages, people and teams.",
    pinned: false,
  ...
  },
  {
    ...
    body: "Public holiday. Remote work as usual.",
    pinned: false,
